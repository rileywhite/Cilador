...
{
    [TestFixture]
    internal class CloningExtensionsFixture
    {
...
#pragma warning restore 649
        ...
        public void SignatureEqualsTest()
        {
            ...
            Assert.IsFalse(intTryParseMethod.SignatureEquals(doubleTryParseMethod, cloningContext));
            Assert.IsFalse(doubleTryParseMethod.SignatureEquals(decimalTryParseMethod, cloningContext));
            ...
            Assert.IsFalse(queueMethod.SignatureEquals(queueClosedMethod, cloningContext));
        }
