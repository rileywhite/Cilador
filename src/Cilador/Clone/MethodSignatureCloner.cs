    ...
    internal class MethodSignatureCloner : ClonerBase<MethodDefinition>
    {
        ...
        protected override MethodDefinition GetTarget()
        {
            ...
            if (this.Source.IsConstructor &&
                ...
                this.Parent is MergedRootTypeCloner)
            {
                var targetStaticConstructor = this.CloningContext.RootTarget.Methods.SingleOrDefault(method => method.IsConstructor && method.IsStatic);
        ...
        protected override void DoClone()
        {
            ...
            if (this.Source.HasOverrides)
            {
                ...
                {
                    this.Target.Overrides.Add(this.CloningContext.RootImport(sourceOverride));
                }
            }
        ...
        private void AddCallToRedirectedStaticConstructor()
        {
            ...
            Contract.Assert(targetStaticConstructor.DeclaringType == this.CloningContext.RootTarget);
