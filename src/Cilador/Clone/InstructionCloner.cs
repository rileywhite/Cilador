...
namespace Cilador.Clone
{
    ...
    internal class InstructionCloner : ClonerBase<Instruction>
    {
        ...
        private sealed class InstructionCreateDispatcher : InstructionOperandFunctionDispatcherBase<Instruction, ILProcessor>
        {
            ...
            /// </summary>
            /// <param name="cloningContext">Context for the cloning operation.</param>
            public InstructionCreateDispatcher(ICloningContext cloningContext)
            {
            ...
            {
                return ilProcessor.Create(opCode, new FieldReference("", this.CloningContext.TargetModule.ImportReference(typeof(void))));
            }
            ...
            protected override Instruction InvokeForOperand(MethodReference operand, OpCode opCode, ILProcessor ilProcessor)
            {
                return ilProcessor.Create(
                    opCode,
                    new MethodReference("", this.CloningContext.TargetModule.ImportReference(typeof(void))));
            }
            ...
            {
                return ilProcessor.Create(opCode, new ParameterDefinition(this.CloningContext.TargetModule.ImportReference(typeof(void))));
            }
            ...
            {
                return ilProcessor.Create(opCode, this.CloningContext.TargetModule.ImportReference(typeof(void)));
            }
            ...
            {
                return ilProcessor.Create(opCode, new VariableDefinition(this.CloningContext.TargetModule.ImportReference(typeof(void))));
            }
        }
        ...
        private class OperandImportDispatcher : InstructionOperandFunctionDispatcherBase<object>
        {
            ...
            {
                return this.CloningContext.RootImport(operand);
            }
