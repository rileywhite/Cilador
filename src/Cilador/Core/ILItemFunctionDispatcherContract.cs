...
{
    /// <summary>
    /// Contracts for <see cref="ILItemFunctionDispatcherBase{TReturn}"/>.
    /// </summary>
    [ContractClassFor(typeof(ILItemFunctionDispatcherBase<>))]
    internal abstract class ILItemFunctionDispatcherContract<TReturn> : ILItemFunctionDispatcherBase<TReturn>
    {
        /// <summary>
