...
{
    /// <summary>
    /// Contracts for <see cref="IILGraph"/>.
    /// </summary>
    [ContractClassFor(typeof(IILGraph))]
    public abstract class ILGraphContracts : IILGraph
    {
        ...
        public IEnumerable<ParentChildILEdge> ParentChildEdges
        {
            get
            {
                Contract.Ensures(Contract.Result<IEnumerable<IILEdge>>() != null);
                throw new NotSupportedException();
            }
        }
        ...
        public IEnumerable<SiblingILEdge> SiblingEdges
        {
            get
            {
                Contract.Ensures(Contract.Result<IEnumerable<IILEdge>>() != null);
        ...
        public IEnumerable<DependencyILEdge> DependencyEdges
        {
            get
            {
                Contract.Ensures(Contract.Result<IEnumerable<IILEdge>>() != null);
