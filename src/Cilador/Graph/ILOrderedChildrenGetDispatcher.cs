...
{
    /// <summary>
    /// Gets child items for IL items in a way that preserves groupings of child types (e.g. types are together,
    ...
    /// </summary>
    internal sealed class ILOrderedChildrenGetDispatcher : ILItemFunctionDispatcherBase<IEnumerable<object>>
    {
        /// <summary>
        /// Handles null items.
        /// </summary>
        ...
        {
            throw new NotSupportedException("Cannot get children of a non-IL item.");
        }
